...
- [ ] Clean up! Delete any of the remaining static branching content. Delete the code that creates `state_branches` and also remove `state_branches` from the final targets vector at the bottom of `_targets.R`.
